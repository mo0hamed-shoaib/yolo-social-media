...
const HomePage = () => {
  ...
  const getInteractionNumbers = (postId) => {
    if (!interactionNumbers.current.has(postId)) {
      interactionNumbers.current.set(postId, generateRandomInteractions(postId));
    }
  ...
  useEffect(() => {
    ...
    const handleOutsideClick = (event) => {
      if (modalRef.current && !modalRef.current.contains(event.target) && showDeleteModal) {
        setShowDeleteModal(false);
        setPostToDelete(null);
      }
    };
  ...
  const handleDeletePost = async () => {
    ...
    try {
      ...
      const response = await postService.deletePost(postToDelete, token);
      if (response.success) {
    ...
    try {
      ...
      if (response.success) {
        setPosts(posts.map(post =>
          post._id === postId ? { ...post, likes: post.likes ? [...post.likes, user._id] : [user._id] } : post
        ));
  ...
  const handleSharePost = async (postId) => {
    try {
      ...
      if (response.success) {
        setPosts(posts.map(post =>
          post._id === postId ? { ...post, shares: post.shares ? [...post.shares, user._id] : [user._id] } : post
        ));
    ...
    <PageTransition>
      <div className="min-h-screen bg-[#191f2b]">
        ...
        <div className="navbar bg-gradient-to-r from-[#1d2838] to-[#1e2939] border-b border-gray-700/50 shadow-lg backdrop-blur-sm">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-lg bg-[#1e2939]/95 backdrop-blur-md rounded-xl w-52 border border-gray-700/50">
                <li><button type="button" className="text-gray-300 hover:bg-[#D984BB]/10 hover:text-white w-full text-left transition-colors duration-200">Home</button></li>
                <li><button type="button" className="text-gray-300 hover:bg-[#D984BB]/10 hover:text-white w-full text-left transition-colors duration-200">Profile</button></li>
                <li><button type="button" className="text-gray-300 hover:bg-[#D984BB]/10 hover:text-white w-full text-left transition-colors duration-200">Settings</button></li>
              </ul>
            </div>
            <button 
              type="button"
            ...
            >
              <img src="/yolo-logo.svg" alt="Yolo Logo" className="w-11 h-11 transition-all duration-200 hover:scale-105 hover:brightness-110" />
            </button>
          </div>
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1">
              <li><button type="button" className="text-gray-300 hover:bg-[#D984BB]/10 hover:text-white transition-colors duration-200 px-4">Home</button></li>
              <li><button type="button" className="text-gray-300 hover:bg-[#D984BB]/10 hover:text-white transition-colors duration-200 px-4">Profile</button></li>
              <li><button type="button" className="text-gray-300 hover:bg-[#D984BB]/10 hover:text-white transition-colors duration-200 px-4">Settings</button></li>
            </ul>
          </div>
              ...
              <div className="hidden lg:block">
                <label className="input input-bordered flex items-center gap-2 bg-[#1e2939]/50 border border-transparent hover:border-[#D984BB]/30 focus-within:border-[#D984BB]/50 text-gray-300 w-64 transition-colors duration-200 rounded-lg focus-within:outline-none">
                  ...
                  <input 
                    ...
                    placeholder="Search..." 
                  />
                  <kbd className="kbd kbd-sm bg-gray-800 text-gray-300 border-gray-700">ctrl</kbd>
                  <kbd className="kbd kbd-sm bg-gray-800 text-gray-300 border-gray-700">k</kbd>
                </label>
              </div>
              <div className="relative">
                ...
                >
                  <div className="indicator">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform transition-all duration-200 group-hover:scale-110 group-hover:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  <div className="w-10 rounded-full ring ring-[#D984BB] ring-opacity-50 transition-all duration-200 hover:ring-opacity-100">
                    <img alt="User avatar" src={user?.profilePicture || "https://ui-avatars.com/api/?name=" + user?.username} className="transition-all duration-200 hover:brightness-110" />
                  </div>
                </button>
                <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow-lg menu menu-sm dropdown-content bg-[#1e2939]/95 backdrop-blur-md rounded-xl w-52 border border-gray-700/50">
                  <li>
                    <button 
                      type="button"
        ...
        <div className="flex flex-1">
          ...
          <aside className="hidden lg:flex w-100 bg-gray-800 p-6 border-r border-gray-700 flex flex-col">
            ...
            <div className="relative overflow-hidden bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 mb-8 border border-gray-700/50">
              <div className="relative w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 group">
                ...
                <img
                  src={user?.profilePicture || "https://via.placeholder.com/150/F299A9/FFFFFF?text=JD"}
                  alt="User Avatar"
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center gap-6 mt-4 text-sm">
                  <div className="group cursor-pointer">
                    ...
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-200">Followers</p>
                  </div>
                  <div className="group cursor-pointer">
                    <p className="font-bold text-lg text-white group-hover:text-[#D984BB] transition-colors duration-200">456</p>
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-200">Following</p>
                  </div>
                </div>
                <button className="mt-6 relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 backdrop-blur-sm rounded-xl px-6 py-3 transition-all duration-300 hover:scale-103 border border-gray-600/70 hover:border-[#D984BB]/70 group w-full cursor-pointer">
                  ...
                  <div className="relative flex items-center justify-center gap-2.5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#D984BB] group-hover:text-[#D782D9] transition-colors duration-200">
                      <path fillRule="evenodd" d="M18.685 19.097A9.723 9.723 0 0 0 21.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 0 0 3.065 7.097A9.716 9.716 0 0 0 12 21.75a9.716 9.716 0 0 0 6.685-2.653Zm-12.54-1.285A7.486 7.486 0 0 1 12 15a7.486 7.486 0 0 1 5.855 2.812A8.224 8.224 0 0 1 12 20.25a8.224 8.224 0 0 1-5.855-2.438ZM15.75 9a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" clipRule="evenodd" />
                    </svg>
                    <span className="text-[#D984BB] group-hover:text-[#D782D9] font-medium transition-colors duration-200">My Profile</span>
                  </div>
                </button>
              </div>
            </div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center">
                      <span className="mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-[#D984BB] group-hover:scale-110 transition-transform duration-300">
                          <path fillRule="evenodd" d="M4.125 3C3.089 3 2.25 3.84 2.25 4.875V18a3 3 0 0 0 3 3h15a3 3 0 0 1-3-3V4.875C17.25 3.839 16.41 3 15.375 3H4.125ZM12 9.75a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5H12Zm-.75-2.25a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5H12a.75.75 0 0 1-.75-.75ZM6 12.75a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5H6Zm-.75 3.75a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75ZM6 6.75a.75.75 0 0 0-.75.75v3c0 .414.336.75.75.75h3a.75.75 0 0 0 .75-.75v-3A.75.75 0 0 0 9 6.75H6Z" clipRule="evenodd" />
                          <path d="M18.75 6.75h1.875c.621 0 1.125.504 1.125 1.125V18a1.5 1.5 0 0 1-3 0V6.75Z" />
                        </svg>
                      </span>
                      <span className="text-lg text-gray-100 group-hover:text-[#D984BB] transition-colors duration-300">News Feed</span>
                    </div>
                  </button>
                </li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                      <div className="flex items-center">
                        <span className="mr-3">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-[#F299A9] group-hover:scale-110 transition-transform duration-300">
                        ...
                        <span className="text-lg text-gray-100 group-hover:text-[#F299A9] transition-colors duration-300">Messages</span>
                      </div>
                      <span className="bg-[#F299A9] text-sm font-bold px-3 py-0.5 rounded-full text-white">6</span>
                    </div>
                  </button>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center">
                      <span className="mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-[#A9D2F2] group-hover:scale-110 transition-transform duration-300">
                      ...
                      <span className="text-lg text-gray-100 group-hover:text-[#A9D2F2] transition-colors duration-300">Groups</span>
                    </div>
                  </button>
                </li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                      <div className="flex items-center">
                        <span className="mr-3">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-[#D984BB] group-hover:scale-110 transition-transform duration-300">
                            <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0A.75.75 0 0 1 21 21h-3.75a.75.75 0 0 0 0-1.5H21a.75.75 0 0 1 0 1.5h-3.75a.75.75 0 0 0 0 1.5Z" clipRule="evenodd" />
                          </svg>
                        </span>
                        <span className="text-lg text-gray-100 group-hover:text-[#D984BB] transition-colors duration-300">Friends</span>
                      </div>
                      <span className="bg-[#D984BB] text-sm font-bold px-3 py-0.5 rounded-full text-white">3</span>
                    </div>
                  </button>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center">
                      ...
                      <span className="text-lg text-gray-100 group-hover:text-[#F299A9] transition-colors duration-300">Videos</span>
                    </div>
                  </button>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center">
                      ...
                      <span className="text-lg text-gray-100 group-hover:text-[#A9D2F2] transition-colors duration-300">Settings</span>
                    </div>
                  </button>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center">
                      <span className="mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-red-400 group-hover:scale-110 transition-transform duration-300">
                          <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.72 6.97a.75.75 0 1 0-1.06 1.06L10.94 12l-1.72 1.72a.75.75 0 1 0 1.06 1.06L12 13.06l1.72 1.72a.75.75 0 1 0 1.06-1.06L13.06 12l1.72-1.72a.75.75 0 1 0-1.06-1.06L12 10.94l-1.72-1.72a.75.75 0 1 0-1.06-1.06L10.94 12Z" clipRule="evenodd" />
                        </svg>
                      </span>
                      <span className="text-lg text-red-400 group-hover:text-red-300 transition-colors duration-300">Logout</span>
                    </div>
                  </button>
                </li>
              </ul>
            ...
            <div className="mb-8 bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-gray-700/50">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-white">Popular Hashtags</h3>
              ...
              <div className="flex flex-wrap gap-2">
                <a href="#" className="group">
                  <span className="bg-gradient-to-br from-gray-700 to-gray-800 text-gray-300 text-sm px-3 py-1.5 rounded-full border border-gray-600 hover:bg-[#D984BB] hover:text-white hover:border-[#D984BB] transition-all duration-300 flex items-center gap-1 hover:shadow-lg hover:shadow-[#D984BB]/20 hover:scale-105">
                    <span className="text-[#D984BB] group-hover:text-white">#</span>
                ...
                <a href="#" className="group">
                  <span className="bg-gradient-to-br from-gray-700 to-gray-800 text-gray-300 text-sm px-3 py-1.5 rounded-full border border-gray-600 hover:bg-[#F299A9] hover:text-white hover:border-[#F299A9] transition-all duration-300 flex items-center gap-1 hover:shadow-lg hover:shadow-[#F299A9]/20 hover:scale-105">
                    <span className="text-[#F299A9] group-hover:text-white">#</span>
                    <span>ReactJS</span>
                  </span>
                </a>
                <a href="#" className="group">
                  <span className="bg-gradient-to-br from-gray-700 to-gray-800 text-gray-300 text-sm px-3 py-1.5 rounded-full border border-gray-600 hover:bg-[#A9D2F2] hover:text-white hover:border-[#A9D2F2] transition-all duration-300 flex items-center gap-1 hover:shadow-lg hover:shadow-[#A9D2F2]/20 hover:scale-105">
                    <span className="text-[#A9D2F2] group-hover:text-white">#</span>
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-gray-400">Join discussions now!</span>
              </div>
                    ...
                    <div className="relative flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center mb-1">
                          <h4 className="text-white font-medium text-base truncate group-hover:text-[#61DAFB] transition-colors duration-200">React Devs</h4>
                        </div>
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className="px-2 py-0.5 text-xs font-medium bg-[#61DAFB]/10 text-[#61DAFB] rounded-full">Trending</span>
                ...
                <a href="#" className="block group">
                  <div className="relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:scale-103 border border-gray-600/70 hover:border-[#DD0031]/70">
                    ...
                    <div className="relative flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center mb-1">
                          <h4 className="text-white font-medium text-base truncate group-hover:text-[#DD0031] transition-colors duration-200">Angular</h4>
                        </div>
                        <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className="px-2 py-0.5 text-xs font-medium bg-[#DD0031]/10 text-[#DD0031] rounded-full">Active</span>
                ...
                <a href="#" className="block group">
                  <div className="relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:scale-103 border border-gray-600/70 hover:border-[#F7DF1E]/70">
                    ...
                    <div className="relative flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center mb-1">
                          <h4 className="text-white font-medium text-base truncate group-hover:text-[#F7DF1E] transition-colors duration-200">JavaScript</h4>
                        </div>
                        <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className="px-2 py-0.5 text-xs font-medium bg-[#F7DF1E]/10 text-[#F7DF1E] rounded-full">Popular</span>
                ...
                <a href="#" className="block group">
                  <div className="relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 backdrop-blur-sm rounded-xl p-4 transition-all duration-300 hover:scale-103 border border-gray-600/70 hover:border-[#F24E1E]/70">
                    ...
                    <div className="relative flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center mb-1">
                          <h4 className="text-white font-medium text-base truncate group-hover:text-[#F24E1E] transition-colors duration-200">UI/UX Design</h4>
                        </div>
                        <div className="flex items-center gap-3">
                          <p className="text-gray-400 text-sm">8.2k members</p>
                          <span className="text-gray-500">•</span>
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className="px-2 py-0.5 text-xs font-medium bg-[#F24E1E]/10 text-[#F24E1E] rounded-full">New</span>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-3 sm:mt-4 gap-3 sm:gap-4">
                    <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <button 
                        ...
                        aria-label={shareLocation ? "Location shared" : "Location not shared"}
                      >
                        {shareLocation ? (
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636" />
                          </svg>
                        )}
                        <span className="text-xs sm:text-sm font-medium">{shareLocation ? 'Share Location' : 'No Location'}</span>
                      </button>
                      <button 
                        type="button"
                        ...
                        aria-label={`Change privacy to ${privacy === 'public' ? 'friends' : privacy === 'friends' ? 'private' : 'public'}`}
                      >
                        {privacy === 'public' ? (
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span className="text-xs sm:text-sm font-medium">
                          {privacy === 'public' ? 'Public' : privacy === 'friends' ? 'Friends' : 'Only You'}
                        </span>
                      </button>
                    </div>
                    <div className="flex justify-end w-full sm:w-auto">
                      ...
                      >
                        {isPosting ? (
                          ...
                          <>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110">
            ...
            <div className="space-y-8">
              {isFetchingPosts ? (
                ...
                posts.length > 0 ? (posts.map(post => (
                  <div key={post._id} className="bg-[#1e2939] rounded-2xl shadow-xl overflow-hidden mb-6 transform transition-all duration-300 hover:shadow-2xl">
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center space-x-4">
                          <div className="relative">
                            <img 
                              src={post.author?.profilePicture || 'https://i.ibb.co/8nhPf8Q0/default-pfp.png'} 
                          ...
                          <div>
                            <h3 className="font-bold text-white text-lg">{post.author?.username || 'Unknown'}</h3>
                      ...
                      <div className="flex items-center justify-between text-gray-400 text-sm pt-4">
                        <div className="flex items-center gap-8">
                          ...
                          >
                            ...
                            <span className="font-semibold">{getInteractionNumbers(post._id).likes}</span>
                          ...
                          >
                            ...
                            <span className="font-semibold">{getInteractionNumbers(post._id).shares}</span>
                          ...
                          >
                            ...
                            <span className="font-semibold">{getInteractionNumbers(post._id).views}</span>
                        ...
                        {post.author?._id === user?._id && (
                          <button 
                            ...
                            className="text-red-400 hover:text-red-300 hover:bg-red-400/10 transition-all duration-200 px-4 py-2 rounded-full cursor-pointer flex items-center gap-2 group"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="px-6 pb-6 border-t border-gray-700">
                      <CommentSection 
                        post={post} 
                        onCommentAdded={(comment) => handleCommentAdded(comment)} 
                      />
                    </div>
                  </div>
                ))) : (
          ...
          {/* Right Sidebar */}
          <aside className="hidden xl:block w-[35rem] bg-gray-800 p-6 border-l border-gray-700">
            {/* Stories Section */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold mb-4">Stories</h3>
              <div className="relative">
                <button className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full shadow-md z-10" onClick={() => document.querySelector('.stories-container').scrollBy({ left: -250, behavior: 'smooth' })}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
                  </svg>
                </button>
                <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-none stories-container items-center px-12" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', height: '180px' }}>
                  {/* Create Story Card */}
                  <div className="relative min-w-[120px] h-40 rounded-xl overflow-hidden border-4 border-gray-400 bg-gray-900 shadow-md cursor-pointer group transition-transform duration-200 hover:scale-105">
                    <img src={user?.profilePicture || "https://ui-avatars.com/api/?name=" + user?.username} alt="Your profile" className="w-full h-full object-cover group-hover:brightness-90 transition duration-200" />
                    ...
                    <div className="absolute bottom-2 left-2 right-2 text-white text-xs font-semibold bg-black/40 rounded px-2 py-1 truncate text-center">Create Story</div>
                  </div>
                  {/* Example Story 1 */}
                  ...
                  <img src={abdoImage} alt="Story" className="w-full h-full object-cover group-hover:brightness-90 transition duration-200" />
                    <div className="absolute top-2 left-2 flex items-center">
                      <img src={abdoProfileImage} alt="User" className="w-10 h-10 rounded-full border-2 border-white shadow-md" />
                    </div>
                    <div className="absolute bottom-2 left-2 right-2 text-white text-xs font-semibold bg-black/40 rounded px-2 py-1 truncate text-center">Abdo Sayed</div>
                  </div>
                  {/* Example Story 2 */}
                  ...
                  <img src={ahmedImage} alt="Story" className="w-full h-full object-cover group-hover:brightness-90 transition duration-200" />
                    <div className="absolute top-2 left-2 flex items-center">
                      <img src={ahmedProfileImage} alt="User" className="w-10 h-10 rounded-full border-2 border-white shadow-md" />
                    </div>
                    <div className="absolute bottom-2 left-2 right-2 text-white text-xs font-semibold bg-black/40 rounded px-2 py-1 truncate text-center">Ahmed Amr</div>
                  </div>
                  {/* Example Story 3 */}
                  ...
                  <img src={aliImage} alt="Story" className="w-full h-full object-cover group-hover:brightness-90 transition duration-200" />
                    <div className="absolute top-2 left-2 flex items-center">
                      <img src={aliProfileImage} alt="User" className="w-10 h-10 rounded-full border-2 border-white shadow-md" />
                    </div>
                    <div className="absolute bottom-2 left-2 right-2 text-white text-xs font-semibold bg-black/40 rounded px-2 py-1 truncate text-center">Ali Ibrahim</div>
                  </div>
                  {/* Example Story 4 */}
                  ...
                  <img src={eliasImage} alt="Story" className="w-full h-full object-cover group-hover:brightness-90 transition duration-200" />
                    <div className="absolute top-2 left-2 flex items-center">
                      <img src={eliasProfileImage} alt="User" className="w-10 h-10 rounded-full border-2 border-white shadow-md" />
                    </div>
                    <div className="absolute bottom-2 left-2 right-2 text-white text-xs font-semibold bg-black/40 rounded px-2 py-1 truncate text-center">Elias Shoaib</div>
                  </div>
                </div>
                <button className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full shadow-md z-10" onClick={() => document.querySelector('.stories-container').scrollBy({ left: 250, behavior: 'smooth' })}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                  </svg>
                </button>
            ...
            <div className="mb-8 bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-gray-700/50">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-100">Suggestions for You</h3>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#D984BB]/20 hover:scale-[1.02] border border-gray-600/70 hover:border-[#D984BB]/70">
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-100 group-hover:text-[#D984BB] transition-colors duration-300 cursor-pointer">Ahmed Zaghloul</p>
                        <p className="text-gray-400 text-sm">@ahmed_zaghloul</p>
                        <div className="mt-1 flex items-center gap-2">
                          <span className="text-xs text-gray-400">2.5k followers</span>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#F299A9]/20 hover:scale-[1.02] border border-gray-600/70 hover:border-[#F299A9]/70">
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-100 group-hover:text-[#F299A9] transition-colors duration-300 cursor-pointer">Yahya Hassan</p>
                        <p className="text-gray-400 text-sm">@squarehead</p>
                        <div className="mt-1 flex items-center gap-2">
                          <span className="text-xs text-gray-400">1.8k followers</span>
                          <span className="text-gray-600">•</span>
                          <span className="text-xs text-gray-400">89 posts</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#A9D2F2]/20 hover:scale-[1.02] border border-gray-600/70 hover:border-[#A9D2F2]/70">
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-100 group-hover:text-[#A9D2F2] transition-colors duration-300 cursor-pointer">Bilal Saad</p>
                        <p className="text-gray-400 text-sm">@bilalsaad92</p>
                        <div className="mt-1 flex items-center gap-2">
                          <span className="text-xs text-gray-400">3.2k followers</span>
                          <span className="text-gray-600">•</span>
                          <span className="text-xs text-gray-400">245 posts</span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="mb-8 bg-gray-800/50 rounded-xl p-4 backdrop-blur-sm border border-gray-700/50">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-100">Recommended Topics</h3>
                <span className="text-xs text-gray-400">Based on your activity</span>
              </div>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#D984BB]/20 hover:scale-[1.02] cursor-pointer border border-gray-600/70 hover:border-[#D984BB]/70">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-xs bg-[#D984BB]/20 text-[#D984BB] px-2 py-1 rounded-full">Trending</span>
                    </div>
                    <p className="text-sm font-medium text-gray-100 group-hover:text-[#D984BB] transition-colors duration-300">UI/UX</p>
                    <p className="text-xs text-gray-400 mt-1">Design & Creativity</p>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#F299A9]/20 hover:scale-[1.02] cursor-pointer border border-gray-600/70 hover:border-[#F299A9]/70">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-xs bg-[#F299A9]/20 text-[#F299A9] px-2 py-1 rounded-full">Popular</span>
                    </div>
                    <p className="text-sm font-medium text-gray-100 group-hover:text-[#F299A9] transition-colors duration-300">Music</p>
                    <p className="text-xs text-gray-400 mt-1">Art & Entertainment</p>
                    <div className="mt-2 flex items-center gap-2">
                      <span className="text-xs text-gray-400">5.8k followers</span>
                      <span className="text-gray-600">•</span>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#A9D2F2]/20 hover:scale-[1.02] cursor-pointer border border-gray-600/70 hover:border-[#A9D2F2]/70">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-xs bg-[#A9D2F2]/20 text-[#A9D2F2] px-2 py-1 rounded-full">New</span>
                    </div>
                    <p className="text-sm font-medium text-gray-100 group-hover:text-[#A9D2F2] transition-colors duration-300">Cooking</p>
                    <p className="text-xs text-gray-400 mt-1">Food & Recipes</p>
                    <div className="mt-2 flex items-center gap-2">
                      <span className="text-xs text-gray-400">1.9k followers</span>
                      <span className="text-gray-600">•</span>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#97D2BF]/20 hover:scale-[1.02] cursor-pointer border border-gray-600/70 hover:border-[#97D2BF]/70">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-xs bg-[#97D2BF]/20 text-[#97D2BF] px-2 py-1 rounded-full">Active</span>
                    </div>
                    <p className="text-sm font-medium text-gray-100 group-hover:text-[#97D2BF] transition-colors duration-300">Hiking</p>
                    <p className="text-xs text-gray-400 mt-1">Outdoor & Adventure</p>
                    <div className="mt-2 flex items-center gap-2">
                      <span className="text-xs text-gray-400">3.2k followers</span>
                      <span className="text-gray-600">•</span>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#E6A4B4]/20 hover:scale-[1.02] cursor-pointer border border-gray-600/70 hover:border-[#E6A4B4]/70">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-xs bg-[#E6A4B4]/20 text-[#E6A4B4] px-2 py-1 rounded-full">Hot</span>
                    </div>
                    <p className="text-sm font-medium text-gray-100 group-hover:text-[#E6A4B4] transition-colors duration-300">Photography</p>
                    <p className="text-xs text-gray-400 mt-1">Visual Arts</p>
                    <div className="mt-2 flex items-center gap-2">
                      <span className="text-xs text-gray-400">4.7k followers</span>
                      <span className="text-gray-600">•</span>
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#9B6B9E]/20 hover:scale-[1.02] cursor-pointer border border-gray-600/70 hover:border-[#9B6B9E]/70">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <span className="text-xs bg-[#9B6B9E]/20 text-[#9B6B9E] px-2 py-1 rounded-full">Rising</span>
                    </div>
                    <p className="text-sm font-medium text-gray-100 group-hover:text-[#9B6B9E] transition-colors duration-300">Technology</p>
                    <p className="text-xs text-gray-400 mt-1">Innovation & Tech</p>
                    <div className="mt-2 flex items-center gap-2">
                      <span className="text-xs text-gray-400">6.3k followers</span>
                      <span className="text-gray-600">•</span>
        ...
        {(showDeleteModal || isModalClosing) && (
          <div className={`fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30 ${isModalClosing ? 'animate-modalFadeOut' : 'animate-modalFadeIn'}`}>
            <div 
              ref={modalRef} 
              className={`bg-gray-800 rounded-lg shadow-lg p-8 max-w-sm w-full text-center ${isModalClosing ? 'animate-modalFadeOut' : 'animate-modalFadeIn'}`}
              role="dialog"
              aria-modal="true"
              aria-labelledby="delete-modal-title"
            >
              <h3 id="delete-modal-title" className="text-xl font-bold mb-4 text-white">Delete Post?</h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div 
              className={`relative bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl transform transition-all duration-300 ${
                isCreateModalClosing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'
              }`}
            >
